...
class Tile {
  ...
  constructor(type, x = 0, y = 0, z = 0) {
    ...
    this.availableUnits = copied[2].slice();
  }
  ...
  canMoveUnits() {
    for (let i = 0; i < this.units.length; i++) {
      if (!this.units[i].worldMoved) return true;
    }
    return false;
  }
...
const TILES = {
  ...
  barracks: [
    ...
    [],
    [
      new __WEBPACK_IMPORTED_MODULE_0__unit__["a" /* default */]('swordsman'),
      new __WEBPACK_IMPORTED_MODULE_0__unit__["a" /* default */]('swordsman'),
      new __WEBPACK_IMPORTED_MODULE_0__unit__["a" /* default */]('archer'),
      new __WEBPACK_IMPORTED_MODULE_0__unit__["a" /* default */]('archer'),
      new __WEBPACK_IMPORTED_MODULE_0__unit__["a" /* default */]('spearman'),
      new __WEBPACK_IMPORTED_MODULE_0__unit__["a" /* default */]('spearman')
    ]
  ],
  orcLonghouse: [
