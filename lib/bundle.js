...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__world_board__ = __webpack_require__(2);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  canvasEl.addEventListener(
    "click",
  e => (Object(__WEBPACK_IMPORTED_MODULE_0__grid__["c" /* onGridClick */])(e, canvasEl, centers, ctx))
);
...
const onGridClick = (e, canvasEl, centers, ctx) => {
...
/* harmony export (immutable) */ __webpack_exports__["c"] = onGridClick;
...
class WorldBoard {
  ...
  dealTile(grid, x, y, z) {
    switch (`[${x}, ${y}, ${z}]`) {
      ...
      break;
      case '[3, 0, -3]':
        grid[x][y][z] = new __WEBPACK_IMPORTED_MODULE_0__tile__["a" /* default */]('barracks', x, y, z);
      ...
      case '[-3, 0, 3]':
        ...
        break;
      default:
        grid[x][y][z] = new __WEBPACK_IMPORTED_MODULE_0__tile__["a" /* default */](TILE_STACK.pop(), x, y, z);
    }
  }
